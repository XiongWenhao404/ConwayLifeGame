...
SIZE, WINDOW_WIDTH, WINDOW_HEIGHT, DELAY = PROPERTY_LIST  # 依据地图属性表导入各属性，依次为：方块大小，窗口宽，窗口高，刷新时长
WIDTH_LEN = WINDOW_WIDTH // SIZE  # 换算出横向方块数量
HEIGHT_LEN = WINDOW_HEIGHT // SIZE  # 换算出纵向方块数量
